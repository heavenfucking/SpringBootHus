            ...
            <div class="row">
                <div class="col-sm-12">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                           <c:forEach items="${teacher_lists}" var="i">
                               <tr>
                                   <td>${i['sno']}</td>
                                   <td>${i['name']}</td>
                                   <td>${i['department']}--
                                   ...
                                   <td>
                                       <div class="btn-group">
                                           ...
                                           <a class="btn btn-sm btn-danger" href="<%=basePath%>teacher/delete/${i['id']}">删除</a>
                                       </div>
                                   </td>
                               </tr>
                           </c:forEach>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" class="form-horizontal" role="form" action="<%=basePath%>teacher/add" method="POST">
                    <div class="form-group">
                        <label  class="col-sm-offset-2 col-sm-2 control-label">教师编号</label>
                        <div class="col-sm-5">
                            <input name="sno" type="text" class="form-control" placeholder="请输入教师编号">
